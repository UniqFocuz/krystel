...
function FragmentationTab(){
    ...
    return(
        ...
        <Card p={5}>
            ...
            <Box px={3}>
                <Text textAlign={'justify'} fontSize={'xs'} color={'gray'} mb={5}>Fragmentor converts your Krystel to Naive Ore. This process can be used to exchange your community rewards to Naive ore for further Research processes.</Text>
                <InputGroup px={3}>
